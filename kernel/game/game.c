...
void drawGround(void) {
    ...
    setGroundObject(&terrian3, ground_obj.groundPos.X + 3 * GND_LENGTH, GND_Y_POS + 10, TERRIAN3_WIDTH, TERRIAN3_HEIGHT); // the terrian2 is 90 before the base ground
...
void defineObstacles(void) {
    ...
    setObStacleObject(&terrian11_square, ground_obj.groundPos.X + TERRIAN11_SQUARE_X_START_OFFSET, ground_obj.groundPos.Y + TERRIAN11_SQUARE_Y_START_OFFSET, 654, 32);
}
...
void gameOn(void) {
    ...
    if (checkCollisionObstacle(mario_char, terrian11_square)) {
        reset();
        //isHitObstacle = 1;
    }
...
void ground_transition_handle(void) {
    ...
    displayObject(terrian2.groundPos.X, terrian2.groundPos.Y, terrian2_terrian2, TERRIAN2_WIDTH, TERRIAN2_HEIGHT);
    displayObject(ground_obj.groundPos.X + TERRIAN1_WIDTH + TERRIAN1_WIDTH + TERRIAN1_WIDTH, ground_obj.groundPos.Y + groundY[3], terrian3_terrian3, TERRIAN3_WIDTH, TERRIAN3_HEIGHT);
