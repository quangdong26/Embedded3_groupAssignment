...
image_build: ./kernel/image/image.c ./kernel/image/marioImg.c ./kernel/image/defaultMario.c ./kernel/image/mariofw.c ./kernel/image/pole.c ./kernel/image/end.c ./kernel/image/mariojump.c ./kernel/image/terrian1.c  ./kernel/image/terrian2.c ./kernel/image/terrian3.c ./kernel/image/defaultGoomba.c ./kernel/image/terrian22.c ./kernel/image/terrian23.c ./kernel/image/terrian25.c ./kernel/image/terrian28.c ./kernel/image/terrian29.c
	...
	aarch64-none-elf-gcc $(GCCFLAGS) -c ./kernel/image/pole.c -o ./build/pole.o
	aarch64-none-elf-gcc $(GCCFLAGS) -c ./kernel/image/end.c -o ./build/end.o
