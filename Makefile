#--------------------------------------Makefile-------------------------------------
include .env
OBJECT = ./build/background1.o ./build/background2.o ./build/goomba.o ./build/game.o ./build/delay.o ./build/obstacle.o ./build/marioImg.o ./build/defaultMario.o ./build/mariojump.o ./build/mariofw.o ./build/terrian1.o ./build/terrian2.o ./build/terrian3.o ./build/terrian22.o ./build/terrian23.o ./build/terrian25.o ./build/terrian28.o ./build/terrian29.o ./build/hitbox.o ./build/framebf.o ./build/image.o ./build/font.o ./build/mario.o ./build/ground.o ./build/mbox.o ./build/utils.o ./build/kernel.o ./build/defaultGoomba.o
