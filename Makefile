...
image_build: ./kernel/image/image.c ./kernel/image/marioImg.c ./kernel/image/defaultMario.c ./kernel/image/mariofw.c ./kernel/image/mariojump.c ./kernel/image/terrian1.c  ./kernel/image/terrian2.c ./kernel/image/terrian3.c ./kernel/image/terrian10.c ./kernel/image/terrian11.c
